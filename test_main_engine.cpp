...
int trade(int slots, int char_per_slot, std::string name) {
    try {
        ...
        while (true) {
            ...
            std::cout << "Total time to recycle the system: " << duration3.count() << " us" <<'\n';
            ...
            std::cout << "Time from first fragment to response: " << duration1.count() << " us" <<'\n';
            std::cout << "Time from last fragment to response: " << duration2.count() << " us" <<'\n';
