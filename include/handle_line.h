...
// inline bool handle_line_test(char* &line_start, char* end, BidAndAsk* best_quotes)
// {
...
//     {
//         boost::split(tempSplit, elem, boost::is_any_of("|"));
...
//             {
//                 bid = best_quote->bid;
//                 if(compare_char_bid_a_geq_b(bid, elem))
//                     bid = elem;
//             }
//             prev_sec = elem == "SEC";
//             prev_ask = elem == "ASK";
